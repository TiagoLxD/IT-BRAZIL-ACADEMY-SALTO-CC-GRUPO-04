...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/truco/signup', formData);
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-8 flex">
                    ...
                    >
                      ...
                      <span>
                        Ao criar uma conta, o utilizador concorda
